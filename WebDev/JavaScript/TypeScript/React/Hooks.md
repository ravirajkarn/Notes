...
Date Created: 2026-06-05 16:23::45 PM
tags:
  - React
---
...
> [!NOTE]  NOTE
> - Hooks are send in batch. i.e if you used `useSate()` simultaneously. expecting you get  3 as result it will not. 
> Example:
> ```js
...
> 	setAge(a + 1);  
> 	setAge(a + 1);  
> 	setAge(a + 1);  // You are hopping that you will get a = 43 
> // ...
> ```


## 1. State Hooks
consider State Hooks as a stander variable  which let you remember the user Input and update it.
