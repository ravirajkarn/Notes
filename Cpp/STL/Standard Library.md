...
Date Created: 2024-07-17T11:34:00
tags:
  - Cpp
  - STL
  - Library
...
- [v] [\<iomanip>](iomanip.md)
- [ ] [\<list>](https://en.cppreference.com/w/cpp/header/list) 
- [v] [\<ostream>](https://en.cppreference.com/w/cpp/header/ostream) 
...
- [v] [[exception]]
- [v] [\<istream>](https://en.cppreference.com/w/cpp/header/istream) 
...
- [x] [\<thread\>](thread.md)
- [x] [\<unordered_map\>](unordered_map.md)
...
- [x] [unordered_set](unordered_set.md)
...
- [x] [[print|<print>]]  ---- use [[fmt]] instead. 
- [ ] [\<stacktrace>](https://en.cppreference.com/w/cpp/header/stacktrace) 
# Headers added in C++26 
- [ ] [\<debugging>](https://en.cppreference.com/w/cpp/header/debugging) 
- [ ] [\<inplace_vector>](https://en.cppreference.com/w/cpp/header/inplace_vector) 
- [ ] [\<linalg>](https://en.cppreference.com/w/cpp/header/linalg) 
- [ ] [\<rcu>](https://en.cppreference.com/w/cpp/header/rcu) 
- [ ] [\<text_encoding>](https://en.cppreference.com/w/cpp/header/text_encoding) 
